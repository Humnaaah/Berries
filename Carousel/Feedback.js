...
let Feeds=[
  {
    feed:"A great experience with their service. I wasable to move to my new house with 1 wek from posting the ad here!",
  ...
  {
    feed:"I really like their service an i will recommend them to who ever needs something moved. You literlly can move anything with them.",
...
const imagesArr = [
  '../Assets/desktop/Group 5/Container_1.png',
  '../Assets/desktop/Group 5/Container_2.png',
  '../Assets/desktop/Group 5/Container_1.png',
  '../Assets/desktop/Group 5/Container_2.png',
  '../Assets/desktop/Group 5/Container_1.png',
  '../Assets/desktop/Group 5/Container_2.png',
...
const SimpleSwiperWithParams = () => {
   ...
   const generateItems = ()=> {
    var items = []
    let level  ;
    console.log("Active default" , active, itemList);
    for (var i = active - 1 ; i < active + 3; i++) {
      ...
      items.push( <CoverItem key={index} id={index} level={level}/>)
  }
  return items
    ...
    //     }
    //     level = active - i
    //     // <CoverItem key={index} id={i} level={level}/>
    //     items.push(   console.log("Index changed index" , index, level, items[index]))
    // }
    // return items
}
