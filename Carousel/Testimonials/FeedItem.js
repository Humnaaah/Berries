...
const responsive = {
  ...
  const FeedItem = (props) => {
      ...
      const children = Feeds.slice(0,3).map(item => (
                  <div draggable={false} key={item.name} className={"ActiveCard"}>
    ...
    return (
      <Carousel
        ...
        partialVisible={true}
        // infinite={props.deviceType === "mobile" && true}
        // draggable={props.deviceType === "mobile" && true}
