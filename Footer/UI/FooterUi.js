                ...
                <Container>
                    <Row>
                        <Col lg={10} sm={12} md={12} className='footerCont'>
                            ...
                            <h6 className='footerSub'> With warehouses in t, Berry Direct has the capacity and network in <br/> place to safely ship all orders, large or small, on time and on budget. </h6>
                        ...
                        <Col lg={2} className="footerDet">
                            <ul>
                                ...
                                <Link to="/about" onClick={()=>maintainLink("about")}>  <li className={activeLink=== "about" ? "active" : ''}> About Us </li> </Link>
                                <Link to="/solutions" onClick={()=>maintainLink("solutions")}>  <li className={activeLink=== "solutions" ? "active" : ''}> Solutions </li> </Link>
                                <Link to="/values" onClick={()=>maintainLink("values")}>   <li className={activeLink=== "values" ? "active" : ''}> Value Added </li> </Link>
                                <a href="http://berrydirect.com/catalog/" onClick={()=>maintainLink("catalogs")}>  <li className={activeLink=== "catalogs" ? "active" : ''}> Catalogs </li> </a>
                                <Link to="/contact" onClick={()=>maintainLink("contact")}>  <li className={activeLink=== "contact" ? "active" : ''}> Contact Us</li> </Link>
                            </ul>
