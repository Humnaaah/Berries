...
const ServicesUI=()=>{
    ...
    return(
        <div className='services'>
            <SideDots ref1={div1} ref2={div2} ref3={div3} ref4={div4} ref5={div5} id1={"div1"} id2={"div2"} id3={"div3"} id4={"div4"} id5={"div5"} extra={true} fourth={true}/>
            <div ref={div1} className="service-main" id="div1">
                <Container>
            ...
            <div ref={div2} className="service-div2" id="div2">
                <Container>
            ...
            <div ref={div3} className="service-div3" id="div3">
                <Container>
            ...
            <div ref={div4} className="service-div4" id="div4">
                <Container> 
                ...
                <ExpandMore clicked={() => {scrollTo(div5.current);}}/>
            </div>
            <div ref={div5} className="service-div5" id="div5">
                <Container>
